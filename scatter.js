...
var plot = function(){
	...
	circles.append("circle").attr("cy", function(d){return (((d[0] * -1) + 34) * 100 ) + 80}).attr("cx", function(d) {return d[1] - 300}).attr("r", 5).attr("fill","black");
	svg.append(circles);
}

button.addEventListener("click", plot);